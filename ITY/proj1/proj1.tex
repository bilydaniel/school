...
\usepackage[top = 2cm, left = 1.5cm, right = 1cm]{geometry}
\usepackage[czech]{babel} 
\usepackage{hyperref}

\begin{document}
\title{Typografie a publikování 1. projekt}
    \author{\fontsize{11}{13}\selectfont Daniel Bílý (xbilyd01@stud.fit.vutbr.cz)}
	\date{}
\maketitle
...
\begin{quote}
Čím více \textbf{druhů}, \emph{řezů}, {\footnotesize velikostí}, barev písma a {jiných} {\tiny\textbf{efektů}} použijeme, tím \emph{profesionálněji} bude dokument vypadat. Čtenář tím bude {\LARGE vždy} {\sc \Huge nadšen!}
\end{quote}
{\sc Tímto pravidlem se nikdy nesmíte řídit.} Příliš časté zvýrazňování textových elementů a změny velikosti písma jsou známkou amatérismu autora a působí velmi rušivě. Dobře navržený dokument nemá obsahovat více než
