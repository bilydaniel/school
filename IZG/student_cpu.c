...
void phong_onInit(int32_t width, int32_t height) {
  ...
  // init lightPosition
  init_Vec3(&phong.lightPosition, 1000.f, 1000.f, 1000.f);//todo 100 nebo 1000?
...
void phong_onDraw(SDL_Surface* surface) {
  ...
  //activating vertex puller
  cpu_bindVertexPuller(phong.gpu,phong.puller);

  //uploading data to uniform values
