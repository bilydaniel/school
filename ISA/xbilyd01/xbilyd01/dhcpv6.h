...
struct dhcp_option{
	unsigned short int option_code;
	unsigned short int option_len;
	//unsigned char option_data[];//FLEXIBLE_ARRAY_MEMBER
};
struct link_option{
    unsigned short int option_code;
    unsigned short int option_len;
    unsigned short int link_type;
    u_char	address[6];
};
struct ia_address{
    unsigned short int ia_code;
    unsigned short int ia_len;
